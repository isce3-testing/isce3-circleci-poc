...
def cmdLineParse():
    ...
    # Required arguments
    parser.add_argument("product", type=str, help="Input HDF5 to be resampled.")
    ...
    parser.add_argument(
        ...
        type=str,
        action="store",
        default="resampSlc/resampSlc.slc",
...
def main(opts):
    ...
    resamp = ResampSlc(
        productGrid, productSlc.getDopplerCentroid(), productGrid.wavelength
    )
    ...
    outds = driver.Create(
        os.path.join(slcPathAndName),
        rgOffsetRaster.width,
        rgOffsetRaster.length,
        1,
        gdal.GDT_CFloat32,
    )
