...
def cmdLineParse():
    ...
    # Required arguments
    parser.add_argument("product", type=str, help="Input secondary HDF5 product.")
    parser.add_argument("topodir", type=str, help="Input topo directory.")
...
def main(opts):
    ...
    geo2rdrObj = isce3.geometry.geo2rdr(
        radarGrid=radarGrid, orbit=orbit, ellipsoid=ellipsoid
    )
    ...
    # Run geo2rdr
    geo2rdrObj.geo2rdr(
        topoRaster, outputDir=opts.outdir, azshift=opts.azoff, rgshift=opts.rgoff
    )
