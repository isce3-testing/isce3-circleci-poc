...
public:
    ...
    FFTPlanBase(std::complex<T>* out, std::complex<T>* in, int n, int batch = 1,
            unsigned flags = FFTW_MEASURE, int threads = getMaxThreads());

    template<int Rank>
    FFTPlanBase(std::complex<T>* out, std::complex<T>* in, const int (&n)[Rank],
            int batch = 1, unsigned flags = FFTW_MEASURE,
            int threads = getMaxThreads());

    FFTPlanBase(std::complex<T>* out, std::complex<T>* in, int n, int nembed,
            int stride, int dist, int batch = 1, unsigned flags = FFTW_MEASURE,
            int threads = getMaxThreads());
    ...
    FFTPlanBase(std::complex<T>* out, std::complex<T>* in, int n, int inembed,
...
protected:
    ...
    FFTPlanBase(U* out, V* in, const int* n, const int* inembed, int istride,
            int idist, const int* onembed, int ostride, int odist, int batch,
            unsigned flags, int rank, int sign, int threads);
