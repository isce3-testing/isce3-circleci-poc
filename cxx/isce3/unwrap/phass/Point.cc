...
Point Point::operator*(int b) { return Point(x * b, y * b); }

//------------------------------------------------------------------------------
int Point::operator*(const Point& b) { return x * b.x + y * b.y; }
...
double D2point::operator*(const D2point& b) { return x * b.x + y * b.y; }
...
{
    stream << std::setprecision(8) << "(" << a.lat << ", " << a.lon << ", "
           << std::setprecision(12) << a.alt << " m)";
    return stream;
}
