...
public:
    ...
    USF3Point(unsigned short s_, unsigned short c_, float x_)
    {
        line = s_;
        pixel = c_;
        x = x_;
    ...
    {
        if (line * 32768 + pixel < b.line * 32768 + b.pixel)
            return true;
        else
            return false;
    }

    void set(int s_, int c_, float x_)
    {
        line = s_;
        pixel = c_;
        x = x_;
...
public:
    ...
    USF4Point(unsigned short s_, unsigned short c_, float x_, float y_)
    {
        s = s_;
        c = c_;
        x = x_;
    ...
    ~USF4Point() {}
    USF4Point operator()(
            unsigned short s_, unsigned short c_, float x_, float y_);
    ...
    {
        if (s * 32768 + c < b.s * 32768 + b.c)
            return true;
        else
            return false;
    }

    void set(int s_, int c_, float x_, float y_)
    {
        s = s_;
        c = c_;
        x = x_;
...
public:
    ...
    bool operator<(const USPointKey& a) const { return key > a.key; }
};
...
public:
    ...
    bool operator<(const PointKey& a) const { return key > a.key; }
};
