...
void heapSort(int n, double* val, int* indexes,
        int order = 0); //   order == 0: small to large;  order == 1: large to
                        //   small;
void heapSort(int n, float* val, int* indexes,
        int order = 0); //   order == 0: small to large;  order == 1: large to
                        //   small;
void heapSort(int n, int* val, int* indexes,
        int order = 0); //   order == 0: small to large;  order == 1: large to
                        //   small;
...
float median_use_histogram(
        int n, float* data, int start_count = 0, int total_size = 0);
// main call using
