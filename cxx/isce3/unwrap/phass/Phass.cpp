        ...
        isce3::io::Raster& labelRaster)
{
    ...
    unwrap(phaseRaster, powerRaster, corrRaster, unwRaster, labelRaster);
}
 ...
 */
void isce3::unwrap::phass::Phass::unwrap(isce3::io::Raster& phaseRaster,
        isce3::io::Raster& powerRaster, isce3::io::Raster& corrRaster,
        isce3::io::Raster& unwRaster, isce3::io::Raster& labelRaster)
{
    ...
    phass_unwrap(nrows, ncols, phase_data, corr_data, power_data, region_map,
