...
void moving_window_average(int items, double* input, int window_length,
        double ped = 0.08); // ped: 1 for uniform; 0.5 Hanning; 0.08
// double *moving_window_average(int items, double *input, int window_length);

double* standard_deviation(
        int items, double* input, int window_length, double* mean = NULL);
