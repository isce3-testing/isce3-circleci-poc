 ...
 * \param[in]  numiterGeo2rdr    maximum number of iterations for Geo2rdr
 * convergence \param[in]  linesPerBlock     number of lines in each block
...
void geocodeSlc(isce3::io::Raster& outputRaster, isce3::io::Raster& inputRaster,
        ...
        const double& demBlockMargin, const bool flatten = true);
