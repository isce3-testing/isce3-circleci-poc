...
public:
    ...
    inline void rangeSamplingFrequency(double rngSampV)
    {
        _rangeSamplingFrequency = rngSampV;
    };
    ...
    inline void rangePixelSpacing(double rngPxl)
    {
        _rangePixelSpacing = rngPxl;
    };
    ...
    inline void commonAzimuthBandwidth(double azBW)
    {
        _commonAzimuthBandwidth = azBW;
    };
    ...
    inline void doCommonAzimuthBandFilter(bool doAz)
    {
        _doCommonAzimuthBandFilter = doAz;
    };
    ...
    inline void doCommonRangeBandFilter(bool doRng)
    {
        _doCommonRangeBandFilter = doRng;
    };
