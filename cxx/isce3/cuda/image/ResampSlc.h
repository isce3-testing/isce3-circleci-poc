...
public:
    ...
    inline ResampSlc(const isce3::core::LUT2d<double>& doppler,
            double startingRange, double rangePixelSpacing, double sensingStart,
            double prf, double wvl)
        : isce3::image::ResampSlc(doppler, startingRange, rangePixelSpacing,
                  sensingStart, prf, wvl)
    {}

    // Constructor from individual components (flattening)
    inline ResampSlc(const isce3::core::LUT2d<double>& doppler,
            double startingRange, double rangePixelSpacing, double sensingStart,
            double prf, double wvl, double refStartingRange,
            double refRangePixelSpacing, double refWvl)
        : isce3::image::ResampSlc(doppler, startingRange, rangePixelSpacing,
                  sensingStart, prf, wvl, refStartingRange,
                  refRangePixelSpacing, refWvl)
    {}
