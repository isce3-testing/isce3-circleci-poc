...
// Tile transformation
void gpuTransformTile(isce3::image::Tile<std::complex<float>>& tile,
        isce3::io::Raster& outputSlc, isce3::image::Tile<float>& rgOffTile,
        ...
        int inWidth, int inLength, double startingRange,
        double rangePixelSpacing, double prf, double wavelength,
        double refStartingRange, double refRangePixelSpacing,
        double refWavelength, bool flatten, int chipSize);
