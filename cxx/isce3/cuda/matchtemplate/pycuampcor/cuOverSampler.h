 ...
 *
 * Define cuOverSampler class, to save cufft plans and perform oversampling
 * calculations For float images use cuOverSamplerR2R For complex images use
 * cuOverSamplerC2C
...
public:
    ...
    // constructor
    cuOverSamplerC2C(int inNX, int inNY, int outNX, int outNY, int nImages,
