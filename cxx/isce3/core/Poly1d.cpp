...
double isce3::core::Poly1d::eval(double xin) const
{
    /*
    ...
    for (int i = 0; i <= order; i++, scalex *= xmod)
        val += scalex * coeffs[i];
    return val;
}

void isce3::core::Poly1d::printPoly() const
{
...
isce3::core::Poly1d isce3::core::Poly1d::derivative() const
{
    /*
