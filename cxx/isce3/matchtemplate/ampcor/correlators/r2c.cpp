...
// helpers
static void _r2c(const float* gamma, std::size_t pairId, std::size_t corDim,
        std::size_t zmdDim, std::complex<float>* scratch);

// convert signal tiles which are assumed to be float to std::complex<float>
auto ampcor::kernels::r2c(const float* gamma, std::size_t pairs,
