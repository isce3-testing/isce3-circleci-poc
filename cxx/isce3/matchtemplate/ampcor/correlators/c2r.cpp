...
// helpers
static void _c2r(const std::complex<float>* scratch, std::size_t pairId,
        std::size_t zmdDim, float* zoomed);

// compute the amplitude of the signal tiles, assuming pixels are of type
// std::complex<float>
auto ampcor::kernels::c2r(const std::complex<float>* scratch, std::size_t pairs,
