...
static void _sat(const value_t* dArena, std::size_t pairId, std::size_t rcells,
        std::size_t tcells, std::size_t tdim, value_t* dSAT);

// implementation
void ampcor::kernels::sat(const float* dArena, std::size_t pairs,
        ...
        float* dSAT)
{
    ...
    // show me
    channel << pyre::journal::at(__HERE__) << "launching SATs computation"
            << pyre::journal::endl;
...
void _sat(const value_t* dArena, std::size_t pairId, std::size_t rcells,
        std::size_t tcells, std::size_t tdim, value_t* dSAT)
{
