...
void addbinding(py::class_<ResampSlc>& pyResampSlc)
{
    pyResampSlc
            .def(py::init<const isce3::core::LUT2d<double>&, double, double,
                    ...
                    py::arg("doppler"), py::arg("start_range"),
                    py::arg("range_pixel_spacing"), py::arg("sensing_start"),
                    py::arg("prf"), py::arg("wavelength"))
            .def(py::init<const isce3::core::LUT2d<double>&, double, double,
            ...
            .def(py::init<const isce3::product::RadarGridParameters&,
                    ...
                    py::arg("rdr_grid"), py::arg("doppler"))
            ...
            .def(py::init<const isce3::product::RadarGridParameters&,
                    ...
                    py::arg("rdr_grid"), py::arg("ref_rdr_grid"),
                    py::arg("doppler"), py::arg("ref_wavelength"),
                    py::arg("wavelength"))
            ...
            .def_property_readonly(
                    "range_pixel_spacing", &ResampSlc::rangePixelSpacing)
            ...
            .def_property_readonly(
                    "ref_start_range", &ResampSlc::refStartingRange)
            .def_property_readonly(
                    "ref_range_pixel_spacing", &ResampSlc::refRangePixelSpacing)
            .def_property_readonly("ref_wavelength", &ResampSlc::refWavelength)
            .def("resamp",
                    py::overload_cast<isce3::io::Raster&, isce3::io::Raster&,
                            isce3::io::Raster&, isce3::io::Raster&, int, bool,
                            bool, int, int>(&ResampSlc::resamp),
                    py::arg("input_slc"), py::arg("output_slc"),
                    py::arg("rg_offset_raster"), py::arg("az_offset_raster"),
                    py::arg("input_band") = 1, py::arg("flatten") = false,
                    py::arg("is_complex") = true, py::arg("row_buffer") = 40,
                    py::arg("chip_size") = isce3::core::SINC_ONE)
            .def("resamp",
                    py::overload_cast<const std::string&, const std::string&,
                            const std::string&, const std::string&, int, bool,
                            bool, int, int>(&ResampSlc::resamp),
                    py::arg("input_filename"), py::arg("output_filename"),
                    py::arg("rg_offset_filename"),
                    py::arg("az_offset_filename"), py::arg("input_band") = 1,
                    py::arg("flatten") = false, py::arg("is_complex") = true,
