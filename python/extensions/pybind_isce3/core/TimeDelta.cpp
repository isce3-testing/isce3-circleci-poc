...
{
    pyTimeDelta.def(py::init<>())
            .def(py::init<double>(), py::arg("seconds"))
            .def(py::init<int, int, int>(), py::arg("hours"),
                    py::arg("minutes"), py::arg("seconds"))
            .def(py::init<int, int, double>(), py::arg("hours"),
                    py::arg("minutes"), py::arg("seconds"))
            .def(py::init<int, int, int, double>(), py::arg("hours"),
                    py::arg("minutes"), py::arg("seconds"), py::arg("frac"))
            .def(py::init<int, int, int, int, double>(), py::arg("days"),
                    py::arg("hours"), py::arg("minutes"), py::arg("seconds"),
                    py::arg("frac"))
            .def(py::init([](const std::chrono::duration<std::int64_t,
                                  std::micro>& duration) {
