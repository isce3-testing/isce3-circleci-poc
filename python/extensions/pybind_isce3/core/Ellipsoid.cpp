...
{
    pyEllipsoid.def(py::init<>())
            .def(py::init<double, double>(), py::arg("a"), py::arg("e2"))
            .def_property("a", (double(Ellipsoid::*)() const) & Ellipsoid::a,
                    (void(Ellipsoid::*)(double)) & Ellipsoid::a)
            .def_property("e2", (double(Ellipsoid::*)() const) & Ellipsoid::e2,
                    (void(Ellipsoid::*)(double)) & Ellipsoid::e2)
            ...
            .def("r_dir", &Ellipsoid::rDir, "Return directional local radius")
            .def("lon_lat_to_xyz",
                    py::overload_cast<const Vec3&>(
                            &Ellipsoid::lonLatToXyz, py::const_),
                    "Transform Lon/Lat/Hgt to ECEF xyz", py::arg("llh"))
            .def("xyz_to_lon_lat",
                    py::overload_cast<const Vec3&>(
                            &Ellipsoid::xyzToLonLat, py::const_),
                    "Transform ECEF xyz to Lon/Lat/Hgt", py::arg("xyz"))
            .def("n_vector",
                    py::overload_cast<double, double>(
                            &Ellipsoid::nVector, py::const_),
