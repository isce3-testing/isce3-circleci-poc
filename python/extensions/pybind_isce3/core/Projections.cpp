    ...
    pyProjectionBase
            ...
            .def("forward",
                    py::overload_cast<const Vec3&>(
                            &ProjectionBase::forward, py::const_),
                    py::arg("llh"),
                    R"(
            ...
            .def("inverse",
                    py::overload_cast<const Vec3&>(
                            &ProjectionBase::inverse, py::const_),
                    py::arg("xyz"),
                    R"(
...
{
    pyLonLat.def(py::init<>()).def("__repr__", [](const LonLat& self) {
...
void addbinding(py::class_<Geocent>& pyGeocent)
{
    ...
    pyGeocent.def(py::init<>()).def("__repr__", [](const Geocent& self) {
...
void addbinding(py::class_<UTM>& pyUTM)
{
    ...
    pyUTM.def(py::init<int>(), py::arg("code"))
...
void addbinding(py::class_<PolarStereo>& pyPolarStereo)
{
    ...
    pyPolarStereo.def(py::init<int>(), py::arg("code"))
...
void addbinding(py::class_<CEA>& pyCEA)
{
    ...
    pyCEA.def(py::init<>()).def("__repr__", [](const CEA& self) {
