...
void addbinding(pybind11::class_<isce3::core::Poly2d>& pyPoly2d)
{
    ...
    pyPoly2d
            ...
            .def(py::init([](const Eigen::Ref<const RowArrayXXd>& coeffs,
                ...
                auto pf_obj = Poly2d(coeffs.cols() - 1, coeffs.rows() - 1,
                        x_mean, y_mean, x_std, y_std);
                pf_obj.coeffs = std::vector<double>(
                        coeffs.data(), coeffs.data() + coeffs.size());
                return pf_obj;
            }),
                    py::arg("coeffs"), py::arg("x_mean") = 0.0,
                    py::arg("y_mean") = 0.0, py::arg("x_std") = 1.0,
                    py::arg("y_std") = 1.0)
            ...
            .def(
                    "eval",
                    [](const Poly2d& self,
                            const Eigen::Ref<const RowArrayXXd>& y,
            ...
            .def_property_readonly(
                    "x_order", [](const Poly2d& self) { return self.xOrder; })
            .def_property_readonly(
                    "y_order", [](const Poly2d& self) { return self.yOrder; })
            .def_property_readonly(
                    "x_mean", [](const Poly2d& self) { return self.xMean; })
            .def_property_readonly(
                    "y_mean", [](const Poly2d& self) { return self.yMean; })
            .def_property_readonly(
                    "x_std", [](const Poly2d& self) { return self.xNorm; })
            .def_property_readonly(
                    "y_std", [](const Poly2d& self) { return self.yNorm; })
            .def_property_readonly("coeffs", [](const Poly2d& self) {
