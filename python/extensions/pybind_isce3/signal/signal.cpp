...
void addsubmodule_signal(py::module& m)
{
    ...
    py::class_<isce3::signal::Covariance<std::complex<float>>>
            pyCovarianceComplex64(m_signal, "CovarianceComplex64");
    py::class_<isce3::signal::Covariance<std::complex<double>>>
            pyCovarianceComplex128(m_signal, "CovarianceComplex128");
    py::class_<isce3::signal::Crossmul> pyCrossmul(m_signal, "Crossmul");
    py::class_<isce3::signal::CrossMultiply> pyCrossMultiply(
            m_signal, "CrossMultiply");
