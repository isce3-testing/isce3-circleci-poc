...
void addbinding(py::class_<GeocodePolygon<T>>& pyGeocodePolygon)
{
    pyGeocodePolygon
            .def(py::init<const std::vector<double>&,
                         ...
                         double, int, double>(),
                    py::arg("x_vect"), py::arg("y_vect"), py::arg("radar_grid"),
                    py::arg("orbit"), py::arg("ellipsoid"),
                    py::arg("input_dop"), py::arg("dem_raster"),
                    py::arg("threshold") = 1e-8, py::arg("num_iter") = 100,
    ...
    Arguments:
        ...
        delta_range         Step size used for computing Doppler derivative
            ...
            .def("get_polygon_mean", &GeocodePolygon<T>::getPolygonMean,
                    py::arg("radar_grid"), py::arg("input_dop"),
                    py::arg("input_raster"), py::arg("output_raster"),
                    py::arg("dem_raster"), py::arg("flag_apply_rtc") = false,
                    ...
                    py::arg("exponent") = 0, py::arg("geogrid_upsampling") = 1,
