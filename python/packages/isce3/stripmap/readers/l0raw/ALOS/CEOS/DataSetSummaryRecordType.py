def DatasetSummaryRecordType():
    ...
    """
    from isce3.parsers.CEOS.BasicTypes import (BlankType, FloatType,
                                               IntegerType, MultiType)
    from isce3.parsers.CEOS.DatasetSummaryRecordType import \
        DatasetSummaryRecordCommonType
    ...
    inlist += [
        ("CalibrationDataIndicator", IntegerType(4)),
