...
class Identification(object):
    ...
    def __init__(self, inobj, path=".", context=None):
        ...
        if context is None:
            context = {
                "info": journal.info("nisar.reader"),
    ...
    def unpack(self, h5grp):
        ...
        """
        import isce3
        from nisar.h5 import bytestring, extractScalar, extractWithIterator

        self.missionId = extractScalar(
            h5grp,
            "missionId",
            bytestring,
            self.context["info"],
        ...
        self.productType = extractScalar(
            h5grp,
            "productType",
            bytestring,
            self.context["error"],
        ...
        self.absoluteOrbitNumber = extractScalar(
            h5grp,
            "absoluteOrbitNumber",
            int,
            self.context["info"],
        ...
        self.lookDirection = extractScalar(
            h5grp,
            "lookDirection",
            bytestring,
            self.context["error"],
        ...
        self.orbitPassDirection = extractScalar(
            h5grp,
            "orbitPassDirection",
            bytestring,
            self.context["info"],
        ...
        self.zdStartTime = extractScalar(
            h5grp, "zeroDopplerStartTime", bytestring, self.context["error"]
        )
        self.zdStartTime = isce3.core.DateTime(self.zdStartTime)

        self.zdEndTime = extractScalar(
            h5grp, "zeroDopplerEndTime", bytestring, self.context["error"]
        )
        self.zdEndTime = isce3.core.DateTime(self.zdEndTime)

        self.boundingPolygon = extractScalar(
            h5grp,
            "boundingPolygon",
            bytestring,
            self.context["info"],
        ...
        self.listOfFrequencies = extractWithIterator(
            h5grp,
            "listOfFrequencies",
            bytestring,
            self.context["error"],
