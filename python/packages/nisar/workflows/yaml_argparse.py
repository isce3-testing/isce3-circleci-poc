...
class YamlArgparse:
    ...
    def __init__(self, resample_type=False):
        ...
        self.parser.add_argument(
            ...
            action="store_false",
            default=True,
            help="Disable logging to file. Log to file on/True by default. If off/False, log file in runconfig yaml will not be read nor altered, log messasges will be sent to stdout, and all submodules will run i.e. no persistence checking.",
        )
        self.parser.add_argument(
            "--restart",
            action="store_true",
