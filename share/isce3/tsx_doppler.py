...
from isce3.core import (dateTime, ellipsoid, lut2d, orbit, statevector,
                        timeDelta)
from isce3.geometry import rdr2geo_cone, rdr2geo_point
...
h = 3.26563146835599719e03  # sceneAverageHeight
...
def squint2(t, r, orbit, attitude, side, sin_az=0.0, h=0.0):
    ...
    xyz = rdr2geo_cone(
        axis=axis, angle=angle, slantRange=r, position=p, demInterp=dem, side=side
    )
    xyz = np.asarray(xyz)
