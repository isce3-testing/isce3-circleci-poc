...
INSTANTIATE_TEST_SUITE_P(
        EPSG_4326, SpatialReferenceTest, testing::Values(4326));
INSTANTIATE_TEST_SUITE_P(
        EPSG_3031, SpatialReferenceTest, testing::Values(3031));
INSTANTIATE_TEST_SUITE_P(
        EPSG_3413, SpatialReferenceTest, testing::Values(3413));
INSTANTIATE_TEST_SUITE_P(
        EPSG_6933, SpatialReferenceTest, testing::Values(6933));
INSTANTIATE_TEST_SUITE_P(
        UTM_North, SpatialReferenceTest, testing::Range(32601, 32661));
INSTANTIATE_TEST_SUITE_P(
        UTM_South, SpatialReferenceTest, testing::Range(32701, 32761));
