...
template<typename T>
inline void fwd_dft_c2c_1d(std::complex<T>* out, const std::complex<T>* in,
        int n, int stride = 1, int batch = 1, int dist = 0)
{
...
template<typename T>
inline void inv_dft_c2c_1d(std::complex<T>* out, const std::complex<T>* in,
        int n, int stride = 1, int batch = 1, int dist = 0)
{
    constexpr std::complex<T> j(0., 1.);
...
template<typename T>
inline void fwd_dft_r2c_1d(std::complex<T>* out, const T* in, int n,
...
template<typename T>
inline void inv_dft_c2r_1d(T* out, const std::complex<T>* in, int n,
        int stride = 1, int batch = 1, int dist = 0)
{
    constexpr std::complex<T> j(0., 1.);
...
template<typename T>
inline void fwd_dft_c2c_2d(std::complex<T>* out, const std::complex<T>* in,
        const std::array<int, 2>& n)
{
...
template<typename T>
inline void inv_dft_c2c_2d(std::complex<T>* out, const std::complex<T>* in,
        const std::array<int, 2>& n)
{
    std::vector<std::complex<T>> z(n[0] * n[1]);
...
inline void fwd_dft_r2c_2d(
        std::complex<T>* out, const T* in, const std::array<int, 2>& n)
{
    std::vector<std::complex<T>> z(n[0] * n[1]);
...
inline void inv_dft_c2r_2d(
        T* out, const std::complex<T>* in, const std::array<int, 2>& n)
{
    std::vector<std::complex<T>> z(n[0] * n[1]);
