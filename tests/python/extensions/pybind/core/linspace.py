...
def test_array():
    x = isce.core.Linspace(0.0, 1.0, 10)
    arr = np.array(x)
...
def test_comparison():
    x1 = isce.core.Linspace(0.0, 1.0, 10)
    x2 = isce.core.Linspace(0.0, 1.0, 10)
    x3 = isce.core.Linspace(1.0, 1.0, 10)
...
def test_search():
    ...
    npt.assert_almost_equal(x.search(-1.0), 0)
    npt.assert_almost_equal(x.search(2.5), 3)
    npt.assert_almost_equal(x.search(11.0), 10)
