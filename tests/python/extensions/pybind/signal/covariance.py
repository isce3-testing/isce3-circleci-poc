...
def test_dualpol_run():
    ...
    cov_list[("hh", "hh")] = isce.io.Raster(
        "cov_hh_hh.vrt", width, length, 1, datatype, "VRT"
    )
    cov_list[("hh", "hv")] = isce.io.Raster(
        "cov_hh_hv.vrt", width, length, 1, datatype, "VRT"
    )
    cov_list[("hv", "hv")] = isce.io.Raster(
        "cov_hv_hv.vrt", width, length, 1, datatype, "VRT"
    )
